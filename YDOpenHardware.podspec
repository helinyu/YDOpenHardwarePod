...
Pod::Spec.new do |s|
	...
	s.source_files = 'ydOpenHardware/Bluetooth/*.{h,m}','ydOpenHardware/extension/*.{h,m}','ydOpenHardware/MSJsonKit/*.{h,m}','ydOpenHardware/WebView/YDBridgeWebViewController.{h,m}'
	s.requires_arc = true
	s.description  = <<-DESC
