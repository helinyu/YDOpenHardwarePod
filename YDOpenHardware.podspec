...
Pod::Spec.new do |s|
	...
	s.source_files = 'ydOpenHardware/YDOpenHardwareThirdPart/YDOpenHardwareThirdPart/*.h','ydOpenHardware/YDOpenHardwareCore/YDOpenHardwareCore/*.h','ydOpenHardware/Bluetooth/*.{h,m}','ydOpenHardware/extension/*.{h,m}','ydOpenHardware/WebView/*.{h,m}'
	s.requires_arc = true
	s.description  = <<-DESC
