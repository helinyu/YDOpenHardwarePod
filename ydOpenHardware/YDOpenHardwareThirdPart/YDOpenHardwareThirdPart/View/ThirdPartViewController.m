...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.row) {
        ...
        case 2: {
            ...
            [is constructByOhiId: nil DeviceId: @"133-test-test" TimeSec: [NSDate date] WeightG: @60000 HeightCm: @170 BodyFatPer: @0 BodyMusclePer: @0 BodyMassIndex: @0 BasalMetabolismRate: @0 BodyWaterPercentage: @0 UserId: @133 Extra: @"" ServerId:@(-1) Status:@(0)];
            ...
            [hr constructByOhhId: nil DeviceId: @"133-test-test" HeartRate: @100 StartTime: [NSDate date] EndTime: [NSDate date] UserId: @133 Extra: @"" ServerId:@(-1) Status:@(0)];
        ...
        case 5: {
            YDOpenHardwareUser *user = [[YDOpenHardwareManager sharedManager] getCurrentUser];
            NSLog(@"user: %@", user);
            break;
        }
