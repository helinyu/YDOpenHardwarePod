 ...
 */
@implementation OpenHardwareIntelligentScale

@synthesize ohiId, deviceId, timeSec, weightG, heightCm, bodyFatPer, bodyMusclePer, bodyMassIndex, basalMetabolismRate, bodyWaterPercentage, userId, extra, serverId, status;
